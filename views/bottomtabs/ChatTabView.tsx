...
const ChatTabView = () => {
  const [messages, setMessages] = useState([
    {
      sender: 'bot',
      text: 'Hi! I am your AI music assistant. How can I help you today?',
    },
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages(prev => {
        ...
        return [
          ...msgs,
          { sender: 'bot', text: 'An error occurred while calling the API.' },
        ];
      });
      scrollViewRef.current?.scrollToEnd({ animated: true });
    }
        ...
        <View style={styles.inputRow}>
          ...
          >
            <Icon
              ...
              size={24}
              color={
                input.trim() ? AppColor.buttonText : AppColor.textSecondary
              }
            />
          </TouchableOpacity>
        </View>
